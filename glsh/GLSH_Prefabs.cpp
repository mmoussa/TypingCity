...
Mesh* CreateSolidBox(float width, float height, float depth, const glm::mat4& transform)
{
    ...
    std::vector<glsh::VPNC> vertices;
    // front face
    vertices.push_back(glsh::VPNC(x1, y1, z2,  0.f, 0.f, 1.f,0.f,0.f,1.f,1.f));
    vertices.push_back(glsh::VPNC(x2, y1, z2,  0, 0, 1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z2,  0, 0, 1, 0.f, 0.f, 1.f, 1.f));

    vertices.push_back(glsh::VPNC(x1, y2, z2,  0, 0, 1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y1, z2,  0, 0, 1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z2,  0, 0, 1, 0.f, 0.f, 1.f, 1.f));

    // back face
    vertices.push_back(glsh::VPNC(x1, y1, z1,  0, 0, -1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y2, z1,  0, 0, -1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z1,  0, 0, -1, 0.f, 0.f, 1.f, 1.f));

    vertices.push_back(glsh::VPNC(x2, y1, z1,  0, 0, -1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y1, z1,  0, 0, -1, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z1,  0, 0, -1, 0.f, 0.f, 1.f, 1.f));

    // right face
    vertices.push_back(glsh::VPNC(x2, y1, z1,  1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z1,  1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z2,  1, 0, 0, 0.f, 0.f, 1.f, 1.f));

    vertices.push_back(glsh::VPNC(x2, y1, z2,  1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y1, z1,  1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z2,  1, 0, 0, 0.f, 0.f, 1.f, 1.f));

    // left face
    vertices.push_back(glsh::VPNC(x1, y1, z1,  -1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y1, z2,  -1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y2, z2,  -1, 0, 0, 0.f, 0.f, 1.f, 1.f));

    vertices.push_back(glsh::VPNC(x1, y2, z1,  -1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y1, z1,  -1, 0, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y2, z2,  -1, 0, 0, 0.f, 0.f, 1.f, 1.f));

    // top face
    vertices.push_back(glsh::VPNC(x1, y2, z1,  0, 1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y2, z2,  0, 1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z2,  0, 1, 0, 0.f, 0.f, 1.f, 1.f));

    vertices.push_back(glsh::VPNC(x2, y2, z1,  0, 1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y2, z1,  0, 1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y2, z2,  0, 1, 0, 0.f, 0.f, 1.f, 1.f));

    // bottom face
    vertices.push_back(glsh::VPNC(x1, y1, z1,  0, -1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y1, z1,  0, -1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y1, z2,  0, -1, 0, 0.f, 0.f, 1.f, 1.f));
 
    vertices.push_back(glsh::VPNC(x1, y1, z2,  0, -1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x1, y1, z1,  0, -1, 0, 0.f, 0.f, 1.f, 1.f));
    vertices.push_back(glsh::VPNC(x2, y1, z2,  0, -1, 0, 0.f, 0.f, 1.f, 1.f));
