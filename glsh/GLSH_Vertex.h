...
//
// a structure that stores vertex position, normal, and color
//
struct VertexPositionNormalColor {

    // the following floats will be laid out consecutively in memory like this: { pos.x, pos.y, pos.z, normal.x, normal.y, normal.z, color.r, color.g, color.b, color.a }
    glm::vec3 pos;
    glm::vec3 normal;
    glm::vec4 color;
    ...
    // fully parameterized constructor initializes all members from arguments
    VertexPositionNormalColor(GLfloat x, GLfloat y, GLfloat z, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat r, GLfloat g, GLfloat b, GLfloat a)
        : pos(x, y, z)
        , normal(nx, ny, nz)
        , color(r, g, b, a)
    { }
...
typedef VertexPositionNormalColor       VPNC;
